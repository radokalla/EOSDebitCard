...
//echo $sql."<br />"; 
		...
		$sql = "SELECT * FROM `"._DB_PREFIX."newsletter_member` nm LEFT JOIN `"._DB_PREFIX."member` m USING (member_id) WHERE nm.send_id = '".mysql_real_escape_string($send_id)."' AND nm.status = 1 AND m.unsubscribe_date = '0000-00-00' LIMIT 1000";
//echo $sql."<br />";
		
		$send['unsent_members'] = qa($sql,$db);
//print_r($send['unsent_members'])."<br />";
//exit;
...
//echo $sql."<br />";
	...
	public function send_out_newsletter($db,$send_id,$member_id, $send_data, $newsletter_data, $newsletter_id=false,$force=false){		
