	...
	<table cellpadding="5">
		...
		foreach($sends as $send){
			...
			<tr>
                ...
                <td><a href="#" onclick="if(confirm('Really delete this newsletter and all newsletter history? Cannot undo!')){ window.location.href='?p=open&newsletter_id=<?php echo $newsletter_id;?>&delete=true'; } return false;">Delete </a></td>
			</tr>
			<?php
		}
		?>
