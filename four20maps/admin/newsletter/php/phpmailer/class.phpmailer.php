 ...
 */
 ...
 // echo "-----".$this->Sender;exit;
  if ($this->Sender == '') {
      ...
      print ("in ELSE");
	  //exit;
	 // echo ",pre";print_r($toArr);
	  //echo $this->SingleTo."------".count($toArr);exit;
	  if ($this->SingleTo === true && count($toArr) > 1) {
        foreach ($toArr as $key => $val) {
          $rt = @mail($val, $this->EncodeHeader($this->SecureHeader($this->Subject)), $body, $header, $params);
          // implement call back function if it exists
      ...
      /*print ($to."<br />");
	  print ($this->EncodeHeader($this->SecureHeader($this->Subject))."<br />");
	  print ($body."<br />");
	  print ($header."<br />");
	  exit;*/
