			...
			<div class="col-lg-12 col-sm-12 col-xs-12">
                ...
                <div class="box-body">
					<?php $notification = notification(); if(!empty($notification)) { ?>
						<div class="alert alert-success catego-succsfl" style="text-align:center" id="hide"><?php echo $notification ?></div>
					<?php } ?>
					<?php if(!empty($_SESSION['msg'])){ ?>
							<div class='alert alert-success' style="text-align:center" id="inactive"><?php echo $_SESSION['msg'];  ?></div>
					<?php } ?>
                          ...
                          <div class="table-responsive"><table id="example1" class="table table-bordered table-striped">
                            <thead>
                              <tr>
								...
								<th class="actions text-center"><?php echo $lang['ADMIN_ACTION']; ?></th>
                              </tr>
                            </thead>
                            <tbody>
                            <?php if(!empty($cats)): ?>
