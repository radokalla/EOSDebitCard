			...
			<div class="row">
            	<div class="col-lg-6 col-sm-12">
						...
						<div class="form-group">
							...
							<input type='text' class="form-control" name='cat_name' onKeyDown="limitText(this.form.cat_name,this.form.countdown,20);" 
									onKeyUp="limitText(this.form.cat_name,this.form.countdown,20);" OnBlur="limitText(this.form.cat_name,this.form.countdown,20);" id='cat_name' value="<?php echo $fields['cat_name']['value']; ?>" />
                        </div>
						<div class="form-group">
                            <label>Map Icon:</label>
						<input type="file" name="map_icon" id="map_icon" <?php if(!empty($cats['cat_icon'])){echo 'disabled="disabled"';} ?>/>
						<?if($cats['cat_icon']!=''){?>
