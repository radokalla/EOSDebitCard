...
$catproducts = getProductCategory();
?>
<html>
	  <head>
                                          ...
                                          <table class="table table-bordered">
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                <td><input type="text" class="form-control"></td>
                                                <td><a href="#" class="btn btn-primary">Search</a></td>
                                              </tr>
                                            </tbody>
                                          </table>
                                    </div>
                                ...
                                <form class="form-horizontal">
                                    <div class="table-responsive">
                                          <table class="table table-bordered">
                                            ...
                                            <?php
											$i=0;
                                            foreach($catproducts as $categoryID=>$catDetails){ $i++;
											?>
                                              <tr>
                                                <th scope="row"><?php echo $i;?></th>
                                                <td><?php echo $catDetails['categoryName'];?></td>
                                                <td><?php echo $catDetails['parentID'];?></td>
                                                <td align="center"><a id="activate-<?php echo $categoryID.'-'.$catproduct['isActive'];?>" href="javascript:;" class="btn btn-success btn-sm"><?php echo ($catDetails['isActive']==1)?'Active':'Inactive';?></a></td>
                                                <td align="center">
                                                <a href="<?php echo '/addproduct.php?prodid='.$categoryID;?>" ><i class="fa fa-pencil"></i></a> 
                                                <a href="javascript:;" id="delete-<?php echo $categoryID;?>" class="deleteproduct"><i class="fa fa-trash"></i></a>
                                                </td>
                                              </tr>
                                             <?php
											}
