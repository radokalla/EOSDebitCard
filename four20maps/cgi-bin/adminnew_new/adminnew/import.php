      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12"><div class="radio">
  <label>
...
<div class="col-lg-12 col-sm-12 col-xs-12"><div class="radio">
  <label>
			...
			<div class="col-lg-12 col-sm-12 col-xs-12">
			<button href="#fileupload" data-toggle="modal" class="btn btn-primary btn-large">Upload CSV</button> <a href="csv/store-samples.csv">Download Sample CSV</a></div>
  ...
  if (isset($_FILES['file'])){
	...
	<input type=hidden name="func" value="restore" />
			...
			<button href="#fileupload2" data-toggle="modal" class="btn btn-primary btn-large">Upload CSV</button> <br />(You can only upload the Backup Stores CSV)
