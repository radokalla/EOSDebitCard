...
//
	$sql = "SELECT *from users WHERE users.username!='admin' $key
	order by $cby $or
    LIMIT $start, $limit";
	$stores = $db->get_rows($sql);
	#var_dump($sql);die;
	$count_sql = "SELECT *from users WHERE users.username!='admin' $key";
...
<body id="stores">
	...
	<div class="modal fade" id="editreview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true" style="top:25%">
					...
					<section>
							...
							<div class="col-md-6">
								<label class="input"> <i class="icon-prepend fa-user"></i>
									First Name<input  type="text" name="userf_name" id="userf_name" placeholder="First Name" value="" class="required">
								</label>
							</div>
							<div class="col-md-6">
								<label class="input"> <i class="icon-prepend fa-user"></i>
									Last Name<input  type="text" name="userl_name" id="userl_name" placeholder="Last Name" value="" class="required">
								</label>
							</div>
							...
							<div class="col-md-6">
								<label class="input"> <i class="icon-prepend fa-user"></i>
								Address	<textarea name="user_address" id="user_address" placeholder="Address" ></textarea>
								</label>
							</div>
							<div class="col-md-6">
								<label class="input"> <i class="icon-prepend fa-user"></i>
								Email	<input  type="text" name="user_email" id="user_email" placeholder="e-mail" value="" readonly>
								</label>
							</div>
						
						
							<div class="col-md-12">
								Status<select id="user_approved" name="user_approved">
