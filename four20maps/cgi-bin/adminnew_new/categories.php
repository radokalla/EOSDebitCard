...
<body id="stores">
	<div id="wrapper">
		...
		<div id="main">
			...
			<a href="./category_add.php" style="float:right"><?php echo $lang['SSF_ADD_CATEGORY']; ?></a>
			<table class="table table-bordered" style="width:100%;">
				<thead>
				<tr>
					<th><?php echo $lang['SSF_CATEGORY_NAME']; ?></th>
					<th title="Icon you usually found on the map">Map Icon</th>					<th title="Icon you usually found on the map icon info window"><?php echo $lang['SSF_CATEGORY_ICON']; ?></th>
