    ...
    <div class="modal-content">
      ...
      <div class="modal-body">     
		<fieldset>
				...
				<div class="row-fluid">
                <div class="span6"><label>Start Date: <span class='required'>*</span></label>

				<input type="text" name='stdate' id='stdate' readonly value='' />
				<input type="hidden" name="iddd" id="iddd" value="" /></div>
				<div class="span6"><label>End Date: <span class='required' >*</span></label>

				<input type="text" name='Enddate'id='Enddate' readonly value='' /></div>
                </div>
                <div class="row-fluid">
                <div class="span6">
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true" style="display:none;">
		<div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title LRhd" id="myModalLabel3">Add Enquiry</h4>
			  </div>
			  <div class="modal-body">
