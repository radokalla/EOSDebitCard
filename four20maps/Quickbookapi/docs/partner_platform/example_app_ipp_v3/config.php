...
$token = 'qyprdA3yYSyQ1zkAQptsD3CImYxhelqbEFM5we445d5dN7I9';
...
$oauth_consumer_key = 'qyprdC6rdk9kE1k5euAnEtrXdTmaWR';
$oauth_consumer_secret = 'gvcqR8ypTwhbXX7EhDn4DJCvuELr2SHdPFfCtBZK';

// If you're using DEVELOPMENT TOKENS, you MUST USE SANDBOX MODE!!!  If you're in PRODUCTION, then DO NOT use sandbox.
$sandbox = false;     // When you're using development tokens
//$sandbox = false;    // When you're using production tokens

// This is the URL of your OAuth auth handler page
$quickbooks_oauth_url = 'http://www.four20maps.com/Quickbookapi/docs/partner_platform/example_app_ipp_v3/oauth.php';

// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth
$quickbooks_success_url = 'http://www.four20maps.com/Quickbookapi/docs/partner_platform/example_app_ipp_v3/success.php';

// This is the menu URL script 
$quickbooks_menu_url = 'http://www.four20maps.com/Quickbookapi/docs/partner_platform/example_app_ipp_v3/menu.php';

// This is a database connection string that will be used to store the OAuth credentials 
// $dsn = 'pgsql://username:password@hostname/database';
// $dsn = 'mysql://username:password@hostname/database';
$dsn = 'mysqli://four20maps:induco123@localhost/four20ma_storefinder';
