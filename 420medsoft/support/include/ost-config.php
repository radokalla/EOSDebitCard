...
define('SECRET_SALT','Y0Ru6vfv5NciM5MBy9qnjHrGldfeTd5q');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','devnull2@installatron.com');
...
define('DBNAME','medsoft_osti3');
define('DBUSER','medsoft_osti3');
define('DBPASS','K#9s1UB)wc63]#5');
