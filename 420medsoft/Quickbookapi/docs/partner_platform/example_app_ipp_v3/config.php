...
require_once dirname(__FILE__) . '/../../../QuickBooks.php';
		...
		$token = '0e02b658bf53fb4608b9fc0bb653045b6bcb';

		

		// Your OAuth consumer key and secret (Intuit will give you both of these when you register an Intuit app)

		$oauth_consumer_key = 'qyprdFR9jN8u1xDUQcVxFgs41AUKfu';

		$oauth_consumer_secret = 'dD7whsON4Satwct12CHsDJssgINhjdMprHqS68iy';



		// This is the URL of your OAuth auth handler page

		$quickbooks_oauth_url = ('http://bayfrontorganics.com/bayfront/Quickbookapi/docs/partner_platform/example_app_ipp_v3/oauth.php');

		

		// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth

		$quickbooks_success_url = ('http://bayfrontorganics.com/bayfront/Quickbookapi/docs/partner_platform/example_app_ipp_v3/success.php');

		

		// This is the menu URL script 

		$quickbooks_menu_url = ('http://bayfrontorganics.com/bayfront/Quickbookapi/docs/partner_platform/example_app_ipp_v3/menu.php');

		

		// This is a database connection string that will be used to store the OAuth credentials 

		$dsn =  'mysql://bayfront_rado:Rado5280@localhost/bayfront_bayfrontdb';			
