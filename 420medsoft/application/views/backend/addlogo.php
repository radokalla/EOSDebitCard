<div class="memberlogin-wps col-md-12 products_page">
  ...
  <div id="message"></div>
    <form method="post" action="<?php echo base_url('index.php/backend/chlogo/'); ?>" role="form" id="add-category-form" class="validate-form" enctype="multipart/form-data">
    <input type="hidden" name="SubscriberID" value="<?php echo $logoss[0]['id']; ?>" />
      <div class="form-group">
        <label for="exampleInputEmail1" class="col-md-4 catogery_name">Header Logo<strong class="star">*</strong> : </label>
        <div class="col-md-6">
          <input type="file" class="form-control text_input1 required " id="file" name="file" /> <img src="<?php echo base_url('images/'.$logoss[0]['headerlogo']); ?>">
          <h5><?php echo $logoss[0]['headerlogo']; ?></h5>
