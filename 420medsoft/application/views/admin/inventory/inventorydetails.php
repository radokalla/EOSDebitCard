...
<div class="memberlogin-wps col-md-12 products_page">
  <h2>Inventory Details
   <a class="category_add" href="<?php echo base_url('index.php/admininventory/getallinventorydetails'); ?>">Edit Inventory</a>
   <a class="category_add" href="<?php echo base_url('index.php/admininventory/inventory'); ?>">Add Inventory</a></h2>
  ...
  <table class="table table-hover table-striped table_hd1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $inventoryStockDetails['totalSales']; ?></td>
        <td><?php echo $inventoryStockDetails['totalRemaining']; ?></td>
        <td><?php echo $inventoryStockDetails['totalStockEmployee']; ?></td>
      </tr>
    </tbody>
    <?php } ?>
  </table>
