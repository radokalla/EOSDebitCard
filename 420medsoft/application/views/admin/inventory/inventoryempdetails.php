...
<div class="memberlogin-wps col-md-12 products_page">
  <h2>Employee Inventory Details
   ...
   <a class="category_add" href="<?php echo base_url('index.php/adminempinventory/inventory'); ?>">Add Employee Inventory</a><?php if($session['LOGIN_TYPE']=='ADMIN'){?>
   <a class="category_add" href="<?php echo base_url('index.php/adminempinventory/getallinventoryempdetails'); ?>">Edit Employee Inventory</a> <?php }?></h2>
