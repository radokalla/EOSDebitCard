...
<div class="memberlogin-wps col-md-12 products_page">
  <h2>Inventory Details <a class="category_add" href="<?php echo base_url('index.php/admininventory/inventory'); ?>">Add Inventory</a></h2>
  ...
  <table class="table table-hover table-striped table_hd1">
    <thead class="table_heading">
      <tr>
        ...
        <th>Total Stock At Employee</th><?php */?>
        <th>Actions</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $inventoryStockDetails['totalRemaining']; ?></td>
        <td><?php echo $inventoryStockDetails['totalStockEmployee']; ?></td><?php */?>
        <td class="textbutton"><a class="glyphicon glyphicon-pencil view_button" title="Edit" data-placement="top" data-toggle="tooltip" href="<?php echo base_url('index.php/admininventory/editinventory/'.$inventoryStockDetails['inventoryID']); ?>"></a>
                </td>
      </tr>
    </tbody>
    <?php } ?>
