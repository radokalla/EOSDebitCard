...
<div class="col-md-6">
	<div class="general-page text-center clearfix">
		...
		<form method="post" id="payment_form" name="payment_form" class="xform" action="http://420medsoft.com/index.php/main/subscribePayment/<?php echo $subscriberDetails['DomainName'];?>">
			<div class="row">
				<div class="col-md-12">
          ...
          <div class="field-wps-rd">
            ...
            <div class="col-md-6 sdsread"  ><?php echo $packages['CurrencySymbol'].number_format($subscriberDetails['RecurringCost'],2); ?></div>
          </div>
