      ...
      <?php if(isset($errorMessage) && !empty($errorMessage)){?><div class="col-md-12 error-message"><?php echo $errorMessage;?></div><?php } ?>
        ...
        <div class="col-md-12">
          ...
          <div class="field-wps-rd">
            ...
            <div class="col-md-6 sdsread"><?php echo $packages['PackageName']; ?></div>
          </div>
          <div class="field-wps-rd">
            <div class="col-md-3">
         ...
         <div class="field-wps-rd">
          ...
          <div class="field-wps-rd">
            ...
            <div class="col-md-6 sdsread"><?php echo $packages['CurrencySymbol'].number_format($packages['Cost'],2); ?></div>
          </div>
          ...
          <div class="field-wps-rd">
            ...
            <div class="col-md-6 sdsread"><input type="text" class="form-control" id="nameOnCard" name="nameOnCard" placeholder=" Name on Card" value="<?php echo isset($patientCreditCardDetails['nameOnCard']) ? $patientCreditCardDetails['nameOnCard'] : ''; ?>" required="required"></div>
          </div>
          ...
          <div class="field-wps-rd">
            ...
            <div class="col-md-6 sdsread"><select id="expiry_month" name="expiry_month" >
          ...
          <div class="field-wps-rd">
            ...
            <div class="col-md-6 sdsread"><select id="expiry_year" name="expiry_year" >
