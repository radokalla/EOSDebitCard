 ...
 */
 ...
 require_once BASEPATH . '../QuickBooks.php';
 
class Quickbooks extends CI_Controller
{
	public function __construct()
	{
		//echo "Nagaraju Bandi"; exit;
		parent::__construct();
	...
	function addCustomerDetails()
	{
		...
		/*$source_options = array('connection_ticket' => 'TGT-73-Atim$OruNnSNyLFdzTaE7g', 
			'application_login' => 'qbintegration4.www.drgsuperhero.com', 
			'application_id' => '508983440', 
			);*/
		...
		echo "Nagaraju<pre>"; print_r($API); exit;
		$return = $API->qbxml('<CustomerAddRq requestID="15">
					<CustomerAdd>
						<Name>Nagaraju Bandi</Name>
						<CompanyName></CompanyName>
						<FirstName>Nagaraju</FirstName>
						<LastName>Bandi</LastName>
						<BillAddress>
							<Addr1>H Colony</Addr1>
							<City>Hyderabad</City>
							<State>Telangana</State>
							<PostalCode>500060</PostalCode>
							<Country>India</Country>
						</BillAddress>
						<Phone>9441808180</Phone>
						 <Email>nagaraju.bandi@inducosolutions.com</Email>
						<Contact>Nagaraju Bandi</Contact>
						<TermsRef>  
							<FullName>Credit Card Billing</FullName>  
						</TermsRef>
		...
		$CustomerData=parse_xml2($return);
	}
